    ...
    <div className="content container">
      <main className="content container">
        ...
        <section className="home-catalog-preview">
          <header>
            <h1 className="catalog-title">New Stuff</h1>
          </header>
        ...
        <section className="home-catalog-preview">
          <header>
            <h1 className="catalog-title">Most loved</h1>
          </header>
        ...
        <section className="home-catalog-preview">
          <header>
            <h1 className="catalog-title">MEN'S</h1>
          </header>
          ...
          <footer className="container">
            <nav>
              <a href="" title="view all" className="catalog-cta">
                view all
              </a>
            </nav>
          </footer>
        ...
        <section className="home-catalog-preview">
          <header>
            <h1 className="catalog-title">WOMEN'S</h1>
          </header>
